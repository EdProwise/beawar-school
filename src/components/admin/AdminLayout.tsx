...
const navItems = [
  ...
  { name: "Highlights", path: "/admin/highlights", icon: Star },
    ...
    { name: "Academic Programs", path: "/admin/programs", icon: BookOpen },
    { name: "Academics Content", path: "/admin/academics", icon: FileText },
    { name: "Admissions Page", path: "/admin/admissions-content", icon: ClipboardList },

  { name: "Portals", path: "/admin/portals", icon: UserCircle },
