...
import { useSiteSettings, useOrbitManagementTeams, type TeamMember } from "@/hooks/use-school-data";
import { Loader2, Users, Search, X, Mail, Info } from "lucide-react";
...
export function OrbitManagementTeams() {
  ...
  return (
    <div className="min-h-screen">
      <SEOHead
        title={`Orbit Management Team | ${schoolName}`}
        description={`Meet the dedicated management team of ${schoolName} driving excellence in education and school administration.`}
        keywords={`management team, school administration, ${schoolName}, Orbit group, leadership`}
        canonicalPath="/orbit-management-teams"
        jsonLd={buildBreadcrumbSchema(siteUrl, [{ name: "Home", path: "/" }, { name: "Orbit Management Team", path: "/orbit-management-teams" }])}
      />
      <Header />
      <main>
        {/* Hero */}
        <section className="pt-32 pb-20 bg-gradient-to-b from-primary to-primary-dark relative overflow-hidden">
          ...
          <div className="container relative text-center">
            ...
            <h1 className="font-heading text-4xl md:text-5xl lg:text-6xl font-bold text-primary-foreground mb-6">
              Orbit Management Team
            </h1>
            <p className="text-primary-foreground/80 text-lg max-w-2xl mx-auto">
              Meet the visionary leaders driving excellence and innovation at {schoolName}.
            </p>
          </div>
        </section>
...
export default OrbitManagementTeams;
