          ...
          <div className="container relative text-center">
            ...
            >
              <span className="inline-flex items-center gap-2 px-4 py-1.5 bg-yellow-500/10 border border-yellow-500/20 text-yellow-400 rounded-full text-sm font-semibold mb-6 backdrop-blur-sm">
                ...
                <h1 className="font-heading text-3xl sm:text-5xl md:text-6xl lg:text-7xl font-bold text-white mb-8 tracking-tight">
                  Entrepreneur <span className="text-blue-500">Skills</span>
                </h1>
                <p className="text-slate-400 text-base sm:text-xl max-w-3xl mx-auto leading-relaxed px-4 sm:px-0">
                ...
                >
                    {sections.map((section, index) => (
                      <motion.div 
                        ...
                        className={`group grid lg:grid-cols-2 gap-8 sm:gap-16 lg:gap-24 items-center overflow-hidden`}
                      >
                        <div className={`${index % 2 === 1 ? 'lg:order-2' : ''} relative min-w-0`}>
                          <div className="absolute -inset-8 bg-gradient-to-br from-blue-500/5 to-purple-500/5 rounded-[3rem] blur-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-700 hidden sm:block" />
                          
                          <div className="relative p-5 sm:p-8 md:p-12 rounded-2xl sm:rounded-[2.5rem] bg-white/70 backdrop-blur-md border border-white shadow-2xl shadow-slate-200/50 hover:shadow-blue-500/10 transition-all duration-500 hover:-translate-y-1 overflow-hidden">
                            ...
                            <div className="space-y-6 sm:space-y-8">
                              <div className="space-y-4 sm:space-y-6">
                                <div className="flex items-center gap-3 sm:gap-4">
                                  <div className="relative group/number flex-shrink-0">
                                    <div className="absolute inset-0 bg-blue-500 blur-lg opacity-20 group-hover/number:opacity-40 transition-opacity" />
                                    <span className="relative flex items-center justify-center w-10 h-10 sm:w-14 sm:h-14 rounded-xl sm:rounded-2xl bg-gradient-to-br from-blue-600 to-blue-400 text-white font-bold text-lg sm:text-2xl shadow-xl shadow-blue-500/30">
                                      {index + 1}
                                    </span>
                                  </div>
                                ...
                                <h2 className="text-xl sm:text-4xl md:text-5xl font-extrabold text-slate-900 tracking-tight leading-tight group-hover:text-blue-600 transition-colors duration-300 break-words [overflow-wrap:anywhere]">
                                  {section.title}
                                </h2>
                              </div>
                              
                              <div className="prose prose-sm sm:prose-lg prose-slate max-w-none text-slate-600 leading-relaxed font-medium break-words [overflow-wrap:anywhere]">
                        ...
                        <div className="relative group/media">
                          <div className="absolute -inset-6 bg-gradient-to-tr from-blue-500/10 to-purple-500/10 rounded-[2.5rem] blur-2xl opacity-0 group-hover/media:opacity-100 transition-opacity duration-700 hidden sm:block" />
                          <div className={`absolute -inset-4 bg-white rounded-[2.5rem] shadow-2xl shadow-slate-200/50 transition-transform duration-700 ${index % 2 === 1 ? '-rotate-2 group-hover/media:-rotate-1' : 'rotate-2 group-hover/media:rotate-1'} hidden sm:block`} />
