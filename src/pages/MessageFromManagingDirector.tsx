...
import { useManagingDirectorMessage, useSiteSettings } from "@/hooks/use-school-data";
import { FormattedContent } from "@/components/ui/formatted-content";
import { Loader2, Building2, GraduationCap, Star, Quote, Users } from "lucide-react";
import SEOHead, { buildBreadcrumbSchema } from "@/components/SEOHead";

export function MessageFromManagingDirector() {
  const { data: message, isLoading } = useManagingDirectorMessage();
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead
        title={`Message from Managing Director | ${schoolName}`}
        description={`Read the message from the Managing Director of ${schoolName}. Leadership vision and commitment to quality education.`}
        keywords={`${schoolName} managing director message, director's address`}
        canonicalPath="/about/message-from-managing-director"
        jsonLd={buildBreadcrumbSchema(siteUrl, [{ name: "Home", path: "/" }, { name: "About", path: "/about" }, { name: "Message from Managing Director", path: "/about/message-from-managing-director" }])}
      />
      <Header />
      <main>
        ...
        <section className="pt-32 pb-24 bg-gradient-to-b from-primary to-primary-dark relative overflow-hidden">
          ...
          <div className="container relative text-center">
            ...
            <h1 className="font-heading text-4xl md:text-5xl lg:text-6xl font-extrabold text-primary-foreground mb-5 leading-tight">
              {message?.message_heading || "Message from Managing Director"}
            </h1>
          ...
          <div className="container relative z-10 max-w-6xl">
            {isLoading ? (
              ...
              <div className="text-center py-32">
                ...
                <p className="text-muted-foreground max-w-sm mx-auto">The managing director's message will be published here shortly.</p>
              </div>
            )}
          </div>
        </section>
