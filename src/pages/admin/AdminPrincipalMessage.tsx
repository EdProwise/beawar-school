...
import { Loader2, Save, GraduationCap, User, MessageSquare } from "lucide-react";
...
export default function AdminPrincipalMessage() {
  ...
  const { data: record, isLoading } = useQuery({
    queryKey: ["admin-principal-message"],
    queryFn: async () => {
  ...
  const [formData, setFormData] = useState({
    ...
    sender_image_url: "",
    message_heading: "Message from Principal",
    message_subheading: "",
    message_content: "",
  ...
  useEffect(() => {
    if (record) {
      setFormData({
        ...
        sender_title: record.sender_title || "Principal",
        sender_image_url: record.sender_image_url || "",
        message_heading: record.message_heading || "Message from Principal",
  ...
  const saveMutation = useMutation({
    ...
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ["admin-principal-message"] });
    ...
    <AdminLayout>
      <div className="max-w-4xl pb-20">
        <div className="mb-8">
          ...
          <p className="text-muted-foreground mt-1">Manage the principal's message shown on the About page</p>
        </div>
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <Input
                  ...
                  placeholder="A word from our principal"
                />
              </div>
              <div>
                <RichTextEditor
