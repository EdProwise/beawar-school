...
export default function AdminAlumni() {
  ...
  const saveMutation = useMutation({
    ...
    onSuccess: () => {
      ...
      toast({ title: "Alumni content updated successfully" });
    },
      ...
      <div className="max-w-4xl pb-20">
        <div className="mb-8 flex items-center justify-between">
          <div>
            ...
            <p className="text-muted-foreground">Manage alumni stories, highlights, and network information</p>
          </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-8">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <Input
                    ...
                    placeholder="e.g., Distinguished Alumni"
                  />
                </div>
                <div>
                  <Label>Content</Label>
          ...
          {sections.length === 0 && (
            <div className="text-center py-12 border-2 border-dashed border-border rounded-lg">
              ...
              <p className="text-muted-foreground">No alumni sections added yet. Click "Add Alumni Section" to start.</p>
            </div>
          )}
