...
const Privacy = () => {
  ...
  const defaultPrivacy = {
    ...
    content: "<p>We are committed to protecting the privacy and security of our students, parents, and staff. This policy outlines how we collect, use, and safeguard your personal information.</p>",
    sections: [
      {
