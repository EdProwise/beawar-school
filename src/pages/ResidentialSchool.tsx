        ...
        <section className="pt-40 pb-24 bg-[#A11B5A] relative overflow-hidden">
          ...
          <div className="container relative text-center">
            ...
            >
              ...
              <h1 className="font-heading text-3xl md:text-6xl lg:text-7xl font-bold text-white mb-8 tracking-tight">
                Residential <span className="text-yellow-400">School</span>
              </h1>
              <p className="text-white/80 text-base sm:text-xl max-w-3xl mx-auto leading-relaxed px-2">
          ...
          <div className="container max-w-7xl mx-auto">
            {isLoading ? (
              ...
              >
                {sections.map((section, index) => (
                  <motion.div 
                    ...
                    className="group grid lg:grid-cols-2 gap-8 sm:gap-16 lg:gap-24 items-center"
                  >
                    <div className={`${index % 2 === 1 ? 'lg:order-2' : ''} relative group/content min-w-0`}>
                      <div className="relative overflow-hidden rounded-2xl sm:rounded-[2.5rem] bg-white border border-slate-200/60 shadow-[0_20px_50px_rgba(161,27,90,0.05)] group-hover:shadow-[0_30px_60px_rgba(161,27,90,0.1)] transition-all duration-500">
                        {/* Side Accent Line */}
                        ...
                        <div className="p-5 sm:p-8 md:p-12 space-y-6 sm:space-y-8">
                          <div className="flex items-start justify-between gap-2">
                            <div className="space-y-2 min-w-0">
                              ...
                              <h2 className="text-xl sm:text-3xl md:text-4xl font-bold text-slate-900 leading-tight break-words [overflow-wrap:anywhere]">
                                {section.title}
                              </h2>
                            </div>
                            <span className="text-3xl sm:text-6xl font-black text-slate-100 select-none group-hover:text-pink-50 transition-colors duration-500 shrink-0">
                              {String(index + 1).padStart(2, '0')}
                            </span>
                          </div>
                          
                          <div className="prose prose-sm sm:prose-lg prose-slate max-w-none text-slate-600 leading-relaxed break-words [overflow-wrap:anywhere]">
                    ...
                    <div className={`${index % 2 === 1 ? 'lg:order-1' : ''} min-w-0`}>
                      <div className="relative group/media">
                        <div className="hidden sm:block absolute -inset-6 bg-gradient-to-tr from-[#A11B5A]/10 to-yellow-500/10 rounded-[2.5rem] blur-2xl opacity-0 group-hover/media:opacity-100 transition-opacity duration-700" />
              ...
              <motion.div 
                ...
                className="text-center py-24 bg-white rounded-2xl sm:rounded-[3rem] border border-slate-100 shadow-xl shadow-slate-200/40 max-w-2xl mx-auto"
              >
